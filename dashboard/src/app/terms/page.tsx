...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-background font-sans">
      <header className="bg-card border-b border-gray-100 py-4">
        <div className="max-w-4xl mx-auto px-4 flex justify-between">
          <Link href="/" className="text-xl font-black text-primary tracking-tight">Automata.</Link>
          <span className="text-sm text-muted-foreground mt-1">Legal</span>
        </div>
      </header>

      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-card rounded-lg shadow-none border border-border p-8 md:p-12 prose prose-indigo max-w-none">
          <h1 className="text-3xl font-bold text-foreground mb-8">Términos y Condiciones del Servicio</h1>
          <p className="text-sm text-muted-foreground mb-8">Última actualización: {new Date().toLocaleDateString()}</p>
          ...
          <div className="space-y-6 text-muted-foreground">
            ...
            <section>
              <h2 className="text-xl font-semibold text-foreground mb-3">3. Uso Aceptable y Cumplimiento con Meta</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-foreground mb-3">4. Responsabilidad</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-foreground mb-3">5. Suscripción y Facturación</h2>
