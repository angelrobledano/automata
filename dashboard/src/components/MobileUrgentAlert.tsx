  ...
  return (
    <div className="md:hidden fixed top-0 left-0 right-0 z-50 animate-fade-in-down">
      <Link href="/conversaciones" className="block w-full">
        <div className="bg-red-600 shadow-lg text-white px-4 py-3 flex items-center justify-between">
          ...
          <div className="bg-white/20 px-3 py-1.5 rounded-full text-xs font-bold whitespace-nowrap">
            Ir al chat →
          </div>
        </div>
      </Link>
